(function () {
  ...
  const TEXT = {
    ...
    ko: {
      ...
      home: { eyebrow: "브라우저 게임 사이트", lead: "모바일과 데스크톱에서 짧게 즐길 수 있는 작은 브라우저 게임 사이트입니다. word chain snake를 브라우저에서 바로 플레이할 수 있습니다.", play: "플레이하기", preview: "word chain snake 게임판 미리보기", sections: "사이트 섹션", cardGame: "단어를 이어 하나의 스네이크 경로를 만듭니다. 긴 단어, 새 칸, 교차 배치로 더 높은 점수를 얻습니다.", cardSiteTitle: "사이트 기본 정보", feature1: "계정 없이 플레이할 수 있습니다.", feature2: "랭킹과 제안은 악용 여부를 검토합니다.", feature3: "모바일 플레이에 맞춰 구성했습니다." },
    ...
    ja: {
      ...
      home: { eyebrow: "ブラウザゲームサイト", lead: "モバイルでもデスクトップでも短時間で遊べる小さなブラウザゲームサイトです。word chain snake をブラウザですぐに遊べます。", play: "プレイする", preview: "word chain snake 盤面プレビュー", sections: "サイト項目", cardGame: "単語をつなげて一つのスネーク経路を作ります。長い単語、新しいマス、交差で得点が増えます。", cardSiteTitle: "サイト基本情報", feature1: "アカウントなしで遊べます。", feature2: "ランキングと提案は不正利用を確認します。", feature3: "モバイルプレイ向けに調整しています。" },
